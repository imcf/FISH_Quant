...
% Last Modified by GUIDE v2.5 17-Dec-2014 14:53:26
...
name_str.old = get(handles.text_rename_old,'String');
name_str.new = get(handles.text_rename_new,'String');

FQ3_outline_replace_color_v1(name_str)
...
par_coloc.flags.save_results = 1;
par_coloc.flags.img_indiv_spots = get(handles.checkbox_plot_img_indiv,'Value');   % Plot results of individual spots
...
%- Call routine
drift  = FQ3_calc_coloc_v3(par_coloc,dist_th);
...
function checkbox_plot_img_indiv_Callback(hObject, eventdata, handles)
