function pos_RNA = sim_cell_membrane_v2(sim_prop,cell_prop)
...
if n_loc > 0
    ind_sub = find(dist_cell_membrane_3D<th_dist_membrane & dist_nucleus_3D>0);  % Outside of nucleus and within distance of cell membrane
    if isempty( ind_sub)
