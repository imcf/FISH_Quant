function FQ3_outline_replace_color_v1(name_str)
...
%  This affects the name of the IMAGE and the OUTLINE.
if nargin <1

    name_str.old = 'channel_CY3';   %- Old part of the name, e.g. channel 1
    name_str.new = 'channel_CY5';   %- New part of the name, e.g. channel 2
                                     %  Will also be used to 
                                     %  name the sub-folder for the new outlines            
end
